...
//   role: AuthRole | null;
//   loading: boolean;
//   signIn: (email: string, password: string, requestedRole: AuthRole) => Promise<void>;
//   signUpStudent: (name: string, email: string, password: string) => Promise<{ needsEmailConfirmation: boolean }>;
//   signOut: () => Promise<void>;
// };

// const AuthContext = createContext<AuthContextValue | undefined>(undefined);

// function getRole(user: User | null): AuthRole | null {
//   if (!user) return null;
...
//     async signIn(email, password, requestedRole) {
...
//         throw new Error(
//           requestedRole === 'admin'
//             ? 'This account is not registered as Teacher/Admin.'
