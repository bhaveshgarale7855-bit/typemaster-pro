...
//   // Password reset flow must stay on Login screen
...
function AppContent() {
  ...
  // Only during password recovery, show the auth screen.
  // Normal website opening still goes directly to MainLayout.
