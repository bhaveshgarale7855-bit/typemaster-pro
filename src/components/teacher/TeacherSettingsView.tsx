...
//   onClose,
// }) => {
//   const { teacher, soundEnabled, toggleSound } = useApp();
...
//                 Manage your TypeMaster Pro teacher preferences.
//               </p>
//             </div>
...
//               <p className="text-sm text-slate-500">
//                 Your current teacher account information.
//               </p>
//             </div>
